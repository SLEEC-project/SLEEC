 ...
 * </ul>
 *
 * @see circus.robocalc.sleec.sLEEC.SLEECPackage#getAtom()
 * @model
 * @generated
 */
public interface Atom extends MBoolExpr
{
   ...
   * @see #setValue(Value)
   * @see circus.robocalc.sleec.sLEEC.SLEECPackage#getAtom_Value()
  ...
  /**
   * Sets the value of the '{@link circus.robocalc.sleec.sLEEC.Atom#getValue <em>Value</em>}' containment reference.
   * <!-- begin-user-doc -->
   * <!-- end-user-doc -->
